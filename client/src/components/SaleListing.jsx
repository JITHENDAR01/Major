            ...
            >
                <div className="content">
                    <h2 className='text-3xl font-bold sm:text-5xl font-heading  text-brand-blue sm:text-left '>
                        Explore our <span className='bg-amber-400 px-1 pb-1'>Book Listings</span>
                    </h2>
                    <p className='font-content font-medium text-sm sm:text-lg mt-3 max-w-3xl'>
                    Dive into a world of amazing deals on pre-loved books! From classic novels to hidden gems, find great reads at unbeatable prices. Start your book journey now!
                    </p>
                </div>
