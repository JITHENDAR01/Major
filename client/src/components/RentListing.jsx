            ...
            >
                <div className="content">
                    <h2 className='text-3xl font-bold sm:text-5xl font-heading  text-brand-blue sm:text-left '>
                        Explore our <span className='bg-amber-400 px-1 pb-1'>Rental Listings</span>
                    </h2>
                    <p className='font-content  font-medium text-sm sm:text-lg mt-3 max-w-3xl'>
                    Discover our Book Showcase! Dive into a world of pre-loved books available for rent. Find your perfect literary match and start reading today. Start exploring now!
                    </p>
                </div>
